...
animate();
  ...
  return (
   ...
   <canvas id="bg"></canvas>
    ...
    <main>
   <header>
   <h3>Name: <span>C.Dinesh</span></h3>
   <h3>DOB: <span>09-07-1994</span></h3>
   <h3>Education: <span>B.Tech(E.C.E) - 2018</span></h3>
  
       
     </header> 
     <header>
     <h3>Previous Experience: <span>I have 4
years of experience in Talent Acquisition (2019 to 2023). Currently undergoing
upskilling to transition into the dynamic field of Software
Development,</span></h3>
